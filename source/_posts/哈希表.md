...
![](https://shoukailiang-blog.oss-cn-hangzhou.aliyuncs.com/article/202211281508148.png)
# 哈希表(散列)-Google上机题
...
2. 代码实现[增删改查(显示所有员工，按id查询)]

![](https://shoukailiang-blog.oss-cn-hangzhou.aliyuncs.com/article/202211281508733.png)
...
class HashTab {
  ...
  public void deleteEmpById(int id) {
    ...
    if (flag) {//找到
      System.out.printf("在第%d条链表中找到 雇员 id = %d，删除成功\n", (empLinkedListNO + 1), id);
    } else {
